...
func (e *Encoder) EncodeUint64(v uint64) error {
	...
	if v <= math.MaxUint8 {
		return e.write1(Uint8, v)
	}
	if v <= math.MaxUint16 {
		return e.write2(Uint16, v)
	}
	if v <= math.MaxUint32 {
		return e.write4(Uint32, v)
	}
...
func (e *Encoder) EncodeInt64(v int64) error {
	...
	if v >= int64(int8(NegFixedNumLow)) {
		return e.w.WriteByte(byte(v))
	}
	if v >= math.MinInt8 {
		return e.write1(Int8, uint64(v))
	}
	if v >= math.MinInt16 {
		return e.write2(Int16, uint64(v))
	}
	if v >= math.MinInt32 {
		return e.write4(Int32, uint64(v))
	}
	return e.write8(Int64, uint64(v))
}

func (e *Encoder) EncodeFloat32(n float32) error {
	return e.write4(Float, uint64(math.Float32bits(n)))
}
